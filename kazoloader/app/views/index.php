    ...
    <div class="col-sm-12">
      ...
      <form id="upload">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn"><button type="button" class="btn btn-primary" onclick="$('input[id=defile]').click();">Browse</button></span>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="dleyInput" name="dlkey" placeholder="ダウンロードキーを入力...">
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
              <label for="delkeyInput">削除Lキー</label>
              <input type="text" class="form-control" id="deleyInput" name="delkey" placeholder="削除キーを入力...">
            </div>
          </div>
        </div>
