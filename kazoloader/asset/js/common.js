$(document).ready(function(){
  ...
  $('input[id=defile]').change(function() {
...
function dl_certificat(id, key){
  ...
  .done(function(data, textStatus, jqXHR){
    var html = '<div class="form-group"><label for="confirmDlkeyInput">ダウンロードキーの入力</label><input type="text" class="form-control" id="confirmDlkeyInput" name="confirmdlkey" placeholder="ダウンロードキーを入力..."></div>';
    switch (data.status){
      case 'failed':
...
function del_certificat(id, key){
  ...
  .done(function(data, textStatus, jqXHR){
    ...
    var html = '<div class="form-group"><label for="confirmDelkeyInput">削除キーの入力</label><input type="text" class="form-control" id="confirmDelkeyInput" name="confirmdelkey" placeholder="削除キーを入力..."></div>';
    switch (data.status){
      case 'failed':
